...
signtool.exe sign /f Server.pfx /fd sha256 /t http://timestamp.digicert.com /debug SecondInstallerBootstrapperEngine.exe
...
signtool sign /f Server.pfx /fd sha256 /t http://timestamp.digicert.com /debug SecondInstallerBootstrapper.exe
